  ...
  return (
    <div className={cn("perspective-1000", cardHeight)} onMouseEnter={() => setIsFlipped(true)} onMouseLeave={() => setIsFlipped(false)}>
      ...
      >
        ...
        >
          <Card className="flex items-center justify-center w-full h-full border-primary/20 shadow-lg bg-card">
            <CardHeader>
        ...
        >
          <Card className="w-full h-full border-primary/20 shadow-lg overflow-y-auto bg-card">
             <CardHeader>
