        ...
        <div className="space-y-8">
            ...
            >
                <div className="space-y-2 text-right">
                    ...
                    <div dir="ltr" className="text-left"><BlockMath math="V \propto \frac{1}{P}" /></div>
                    <p className="text-sm">لذلك، حاصل ضربهما يساوي ثابتًا (k):</p>
                    <div dir="ltr" className="text-left"><BlockMath math="P \cdot V = k" /></div>
                    <p className="text-sm">لمقارنة حالتين للغاز:</p>
                    <div dir="ltr" className="text-left"><BlockMath math="P_1 V_1 = P_2 V_2" /></div>
                </div>
            </FlippableCard>
