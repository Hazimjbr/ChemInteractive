...
export const staticQuizLvl1: QuizQuestion[] = [
    ...
    {
        "question": "عينة من غاز النيون حجمها 1 لتر عند الظروف المعيارية (STP). ما هو حجمها عند ضغط 2 atm ودرجة حرارة 273 كلفن؟",
        "options": [
            "0.5 لتر",
            "1 لتر",
            "2 لتر",
        ...
        "explanation": "الظروف المعيارية هي T₁=273K, P₁=1atm. V₁=1L. الظروف الجديدة T₂=273K, P₂=2atm. V₂ = (P₁V₁T₂)/(P₂T₁) = (1*1*273)/(2*273) = 0.5 لتر. (هذا تطبيق لقانون بويل حيث الحرارة ثابتة)."
    },
    {
        "question": "غاز حجمه 2 لتر عند ضغط 1 atm ودرجة حرارة 300K. إذا أصبح حجمه 1 لتر وضغطه 4 atm، فما هي درجة حرارته الجديدة بالكلفن؟",
        "options": [
            "150K",
            "300K",
            "600K",
...
export const staticQuizLvl2: QuizQuestion[] = [
    ...
    },
    {
     ...
     {
        "question": "عينة من الهواء حجمها 4 L وضغطها 202.6 kPa عند درجة حرارة 20 °C فإذا أصبحت حرارتها 278 K وحجمها 2500 ml فإن ضغطها بوحدة atm يساوي:",
        "options": [
            "200",
            "1",
            "3",
    ...
    {
        "question": "عينة من غاز حجمها 5 L وضغطها 1.8 atm عند درجة حرارة 25 °C فإذا انخفضت درجة حرارتها بمقدار 10 درجات وأصبح ضغطها 0.8 atm فإن حجمها بوحدة L يساوي:",
        "options": [
            "10.9",
            "10.7",
            "6.8",
    ...
    {
        "question": "إذا كان ضغط عينة من الغاز يساوي 0.3 atm عند درجة حرارة 0 °C وأردنا رفع الضغط إلى 0.6 atm فيجب أن نغير درجة حرارتها بمقدار يساوي:",
        "options": [
            "+273 °C",
            "+546 °C",
            "-273 °C",
